...
export default function App() {
  ...
  function renderComputer(choice) {
        ...
        >
          <div>
            <div className="game-state-content">
              <p>{renderComputer(userChoice)}</p>
              {/* <p>you {gameState}!</p> */}
              {gameState === 'win' && <p>Congrates! You won!</p>}
              {gameState === 'lose' && <p>Sorry! You lose!!</p>}
              {gameState === 'draw' && <p>You drew!</p>}
              <p>{renderComputer(computerChoice)}</p>
            </div>
